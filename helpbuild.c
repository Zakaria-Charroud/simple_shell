...
/**
 * display_help_all - Displays information about all possible builtin Shellby commands.
 */
void display_help_all(void)
{
...
/**
 * display_help_alias - Displays information about the Shellby builtin command 'alias'.
 */
void display_help_alias(void)
{
...
/**
 * display_help_cd - Displays information about the Shellby builtin command 'cd'.
 */
void display_help_cd(void)
{
...
/**
 * display_help_exit - Displays information about the Shellby builtin command 'exit'.
 */
void display_help_exit(void)
{
...
/**
 * display_help_help - Displays information about the Shellby builtin command 'help'.
 */
void display_help_help(void)
{
